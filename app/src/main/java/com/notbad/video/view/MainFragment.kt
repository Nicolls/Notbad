...
import com.notbad.video.NotBadApplication
...
class MainFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        (activity as MainActivity).loginGraph.inject(this)
    ...
    override fun onCreateView(
        ...
        loginViewModel.repository.localDataSource.dataHandler.handleData("main data")
